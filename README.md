...
Completion snapshot, based only on landed repository features and verification state (truth-synced 2026-04-29 after browser portable artifact request modes landed in commits `ecc1e35` and `12874a4`, with targeted browser tests, browser lib tests, clippy, and diff checks passing):
