...
Completion snapshot, based only on landed repository features and verification state (truth-synced 2026-04-29 after browser encrypted portable artifact JSON download/copy behavior and explicit portable artifact JSON filename detection landed, with targeted browser vault export and portable artifact tests plus `mdid-browser` clippy passing):
